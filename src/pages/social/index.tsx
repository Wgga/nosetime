...
export default class Social extends React.Component {
	...
	handleScroll = () => {
		const { currentlyOpenSwipeable }: any = this.state;
	...
	render() {
		const { currentlyOpenSwipeable }: any = this.state;
		const itemProps = {
			onOpen: (event: any, gestureState: any, swipeable: any) => {
...
function Example1({ onOpen, onClose }: any) {
	return (
		<Swipeable
			leftContent={(
...
function Example2({ onOpen, onClose }: any) {
	return (
		<Swipeable
			leftButtonWidth={45}
			leftButtons={[
